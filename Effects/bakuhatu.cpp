...
void bakuhatuEffect::Init()
{
	effects.clear();
}

void bakuhatuEffect::Update() {
...
void bakuhatuEffect::LoadTexture()
{
    texture.Load("Texture/EffectTexture/Impact_Cartoon Hit_V6_spritesheet.png");
}

void bakuhatuEffect::Release()
{
	effects.clear();
	texture.Release();
}

void bakuhatuEffect::SetEffect(float posX, float posY, bool isActive)
{
    Effect newEffect;
