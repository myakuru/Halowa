...
void BurstFlogEffect::Init()
{
	effects.clear();
}

void BurstFlogEffect::Update() {
...
void BurstFlogEffect::Draw() {
    for (const auto& effect : effects) {
        ...
        DirectX::SimpleMath::Color color = { 1.0f, 0.5f, 0.0f, 0.2f };
...
void BurstFlogEffect::LoadTexture()
{
	texture.Load("Texture/EffectTexture/Charge_Water_v1_A_Burst Only_spritesheet.png");
}

void BurstFlogEffect::Release()
{
	effects.clear();
	texture.Release();
}

void BurstFlogEffect::SetEffect(float posX, float posY, bool isActive)
{
    Effect newEffect;
